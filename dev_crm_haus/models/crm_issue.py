...
class CrmIssue(models.Model):
    ...
    temporary_location_selection = fields.Selection([('HAUS! JKT - BINUS 1', 'HAUS! BINUS 1'),
 ...
 ('Haus Office Sastra Graha', 'Haus Office Sastra Graha')],string="Sites Selection",default="Haus Office Meruya")
